...
Visit [PokeDexPro] ([https://chirag-pokedexproplus.netlify.app/]) to see the live application.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Chiragtomar58/PokeDexPro-T.git
   ```
...
- Twitter: [@PokeDexPro](https://twitter.com/pokedexpro-T)
- Issues: [GitHub Issues](https://github.com/Chiragtomar58/PokeDexPro-T/issues)
...
See our [Issues](https://github.com/Chiragtomar58/PokeDexPro-T/issues) page for current known issues.
